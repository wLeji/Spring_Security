    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api").hasRole("USER") // Accès rebond
                        .requestMatchers("/api/scrapping").hasRole("SCRAPPER") // Accès scrapping
                        // Accès public a certaines routes, notamment la page d'accueil, l'inscription et le login
                        .requestMatchers( "/","/index", "/user/register", "/user/login", "/user/logout").permitAll()
